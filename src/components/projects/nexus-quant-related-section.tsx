      ...
      >
        <div className="space-y-6 bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))] p-6 md:p-8">
          ...
          <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
            <div className="relative overflow-hidden rounded-[1.4rem] border border-white/10 bg-[radial-gradient(circle_at_75%_20%,rgba(255,166,89,0.3),transparent_26%),linear-gradient(135deg,rgba(48,39,72,0.85),rgba(8,10,18,0.96))] px-5 py-8 shadow-[0_18px_42px_rgba(12,16,28,0.22)] md:px-7 md:py-9">
              ...
              <div className="pointer-events-none absolute inset-x-[18%] top-8 h-16 rounded-full bg-white/[0.04] blur-3xl" />
              {nexusQuantRelatedWorks.map((work) => (
                <div key={work.title} className="relative max-w-xl">
                  ...
                  <h2 className="ui-section-title mt-4 max-w-[13ch] text-foreground md:text-[clamp(1.95rem,2.2vw,2.55rem)]">
                    {work.title}
                  </h2>
                  <p className="ui-body-sm mt-4 max-w-lg text-foreground/72 md:text-[14px]">
                    {work.description}
                  </p>
                </div>
              ))}
            ...
            {nexusQuantRelatedWorks.map((work, index) => (
              <Card
                ...
                className={cn(
                  ...
                  "shadow-[0_10px_26px_rgba(27,44,74,0.08)]"
                )}
              >
