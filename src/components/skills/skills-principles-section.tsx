  ...
  return (
    <section className="pt-9 md:pt-12">
      <Card
        ...
        padding="lg"
        tone="muted"
        className="rounded-[2rem] border-white/8 px-5 py-6 shadow-[0_18px_48px_rgba(0,0,0,0.08)] md:px-8 md:py-8"
      >
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(18rem,0.82fr)] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="grid gap-3">
              {principles.map((principle) => (
                ...
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-foreground/8 text-[11px] font-semibold text-foreground">
                    {principle.index}
                  </div>
          ...
          <div className="relative mx-auto w-full max-w-[24rem] lg:max-w-none">
            <div className="pointer-events-none absolute inset-x-[18%] top-6 h-24 rounded-full bg-foreground/6 blur-3xl" />
            <div className="relative overflow-hidden rounded-[1.7rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-3 shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
              <div className="relative aspect-[0.92] overflow-hidden rounded-[1.35rem] border border-white/8 bg-[linear-gradient(145deg,rgba(238,243,255,0.12),rgba(27,34,46,0.82))]">
                ...
                <div className="absolute left-[29%] top-[22%] h-px w-[14%] bg-foreground/35" />
                <div className="absolute left-[48%] top-[38%] h-[18%] w-px bg-foreground/28" />
                <div className="absolute left-[34%] top-[63%] h-px w-[24%] bg-foreground/32" />
                <div className="absolute left-[68%] top-[62%] h-[11%] w-px bg-foreground/24" />
              </div>
