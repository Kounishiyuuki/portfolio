  ...
  return (
    <SectionContainer spacing="compact" className="pt-5 md:pt-8">
      <Card
        ...
        padding="none"
        tone="muted"
        className="relative overflow-hidden rounded-[1.8rem] border-white/12 px-5 py-6 shadow-[0_16px_42px_rgba(0,0,0,0.07)] md:px-7 md:py-7"
      >
        <div className="pointer-events-none absolute inset-x-[16%] top-0 h-24 rounded-full bg-foreground/6 blur-3xl" />
        ...
        <div className="relative grid gap-6 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:items-start">
          <div className="layout-header space-y-3">
            ...
            <InternalLink
              href="/about"
              className="inline-flex items-center gap-1.5 text-sm font-semibold text-foreground transition-colors duration-200 hover:text-foreground"
            >
              詳しいプロフィールを見る
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {journeyItems.map((item) => (
              <div
                ...
                className="rounded-[1.25rem] border border-line/65 bg-[linear-gradient(180deg,rgba(255,255,255,0.84),rgba(247,250,255,0.62))] px-4 py-4 shadow-[0_10px_26px_rgba(0,0,0,0.045)]"
              >
